...
![Ablation](../figures/ablation_image_vs_cnn.png)
...
![Model correlation](../figures/model_correlation_matrix.png)
...
![2D CNN loss curves](../figures/2d_cnn_loss_curves.png)
...
![3-stage lift](../figures/ensemble_lift_progression.png)
...
*공개 레포의 핵심 숫자와 산출물은 `outputs/ode_handoff/`와 `docs/figures/`에서 확인 가능.*
